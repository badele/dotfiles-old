...
from fabtools.files import is_file, watch, is_dir
...
def install():
    ...
    #############################################################
    # === Before execute this script, please run bottom lines ===
    #############################################################
    loadkeys fr
    passwd
    ...
    # == HDD configuration
    # prepare partition with same confiration from computer_.env.part
...
def require_partition():
    ...
    r = disk.partition_type_exists(env.disk, env.part['/boot']['device'],
                                   'Linux')
    r = r and disk.partition_type_exists(env.disk, env.part['swap']['device'],
                                         'Linux swap / Solaris')
    r = r and disk.partition_type_exists(env.disk, env.part['/']['device'],
                                         'Linux')
